class Card {
    constructor(_x, _y, _w, _h) {
        ...
        this.offsetX = editRandom(-10, 10);
        this.offsetY = editRandom(-10, 10);
        this.offsetRot = editRandom(-10, 10);

        this.backOffsetX = _x;
        this.backOffsetY = _y;
        this.backRotation = 0;

        this.isFlip = editRandom() < 0.5;
        this.cropType = int(editRandom(0, 3));

        this.frontRemovePoints = [];

        this.seed = editRandom(-100000, 100000);
    ...
    cropCard(_ratioA, _ratioB) {
        ...
        // corner left top
        if (this.cropType == 2) {
            let cornerType = int(editRandom(0, 4));
